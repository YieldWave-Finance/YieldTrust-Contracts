...
**What it tests:** 1,000 partial withdrawals across 5 beneficiaries with awkward
share allocations
...
2. **Invariant Maintenance:** `contract_balance >= obligations` after every
   withdrawal
...
This test suite focuses specifically on **division rounding behavior** and the
Point One Cent exploit.
