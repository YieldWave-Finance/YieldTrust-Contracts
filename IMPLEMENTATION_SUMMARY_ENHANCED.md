...
This document outlines the implementation of four major features requested in
the GitHub issues for the Grant-Stream smart contract on Soroban.

## Feature 1: Auto-Swap Integration for Diversified Withdrawals (#281)

### Implementation

- Added `withdraw_as_stable` function that automatically swaps grant tokens to
  stablecoins via Stellar DEX
...
- Implemented snapshot pattern for efficient share calculations in yield-bearing
  pools
